window.requestAnimFrame = function () {
  ...
  var canvas = document.getElementById('canvas'),
      ...
      verticalPointRange = 50, // Уменьшена высота
  ...
  var renderPath = function () {
    context.strokeStyle = '#FFFFFF'; // Устанавливаем белый цвет обводки
  ...
  var clear = function () {
    context.clearRect(0, 0, canvasWidth, canvasHeight); // Полностью очищаем холст
  }
